...
![Tela inicial do Control Plane - dashboard de métricas e saúde do ambiente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_01.png)

Na parte superior, podemos criar novos agents, explorar o catálogo de agents ou retomar trabalhos recentes.

![Parte superior do dashboard - opções para criar agentes, explorar catálogo e trabalhos recentes](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_02.png)

A seção **Needs Attention** destaca problemas no ambiente de AI agents que podem exigir atenção:

![Seção Needs Attention - problemas no ambiente que requerem atenção](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_03.png)
...
![Seção Platform Analytics - resumo de modelos e controles por asset](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_04.png)
...
![Seção Agent Analytics - agentes ativos, mensagens, falhas e métricas de latência](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_05.png)
...
![Needs Attention - alertas de Operations com bloqueios operacionais conhecidos](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_06.png)
...
![Needs Attention - alertas de Incidents com taxa de falha do agente nas últimas 24h](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_07.png)
...
![Needs Attention - alertas de Insights com recomendações para melhorar qualidade dos agentes](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_08.png)
...
![Alertas operacionais - link de ação na coluna Actions para detalhar o problema](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_09.png)
...
![Página de avaliação de agente aberta a partir do alerta operacional](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_10.png)
...
![Painel Agent Analytics - inventário de agentes com tabela de conversas e métricas por agente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_11.png)

Clique em **View agent analytics**

![Tela de Agent Analytics completa com filtros de período e gráfico de tendência por agente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_12.png)
...
![Seleção de agente específico na tabela de Agent Analytics](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_13.png)
...
![Aba Overview do agente selecionado - métricas de conversas, tokens, usuários, latência e feedback](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_14.png)

Clique na aba `Conversations`

![Aba Conversations do agente - lista de conversas individuais com transcrição e detalhes](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_15.png)
...
![Ícone de debug (joaninha) para acessar a tela de depuração da conversa](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_16.png)
...
![Tela de Debug - fluxo de execução com nós User input, Agent, LLM, Tool, Knowledge base e Answer](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_17.png)

Clique no ícone de alterar a visualização do fluxo, nomeado como 6 na imagem anterior.

![Debug - visualização com caminho ativo destacado em azul mostrando o trajeto real da execução](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_18.png)
...
![Debug - layout em árvore horizontal reorganizando o diagrama de execução da esquerda para a direita](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_19.png)
...
![Debug - aba Input do nó User input exibindo a mensagem enviada pelo usuário](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_20.png)
...
![Debug - nó Agent expandido mostrando sub-passos de raciocínio, colaboração, processamento e resposta](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_21.png)
...
![Debug - aba LLM Model em Node properties exibindo o modelo de linguagem utilizado pelo agente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_21-b.png)
...
![Debug - aba About em Node properties com nome, display name e descrição do agente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_21-c.png)

Navegue até a seção de `Platform analytics`

Na seção `Control`, clique em `View all`

![Seção Platform Analytics - Controls com opção View all na área de controles](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_22.png)
...
![Página de Controls - Asset Controls e Enterprise Controls sem nenhum controle criado ainda](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_23.png)
...
![Pop-up de criação de controle - tipos disponíveis para agentes, tools e modelos](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_24.png)

1. Selecione `Content Guardrails` para testar uma das opções disponíveis.

2. Em seguida, clique em `Next`

![Seleção de Content Guardrails como tipo de controle e clique em Next](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_25.png)
...
![Configure Control - nome, descrição e Enforcement type do controle Content Guardrails](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_26.png)
...
![Configure Control - toggles de detecção por tipo de conteúdo: sexual, violência, HAP, harm, jailbreak e viés social](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_27.png)
...
![Configure Control - tipos de conteúdo ativados e mensagem de bloqueio personalizada definida](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_28.png)


Clique em `Add agent` para criar o guardrail em um agente

![Assign asset - clique em Add agent para vincular o controle a um agente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_29.png)
...
![Janela Add agent - seleção do agente orquestrador para aplicar o controle](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_30.png)

Clique em `Next`

![Assign asset - confirmação dos agentes selecionados antes de prosseguir](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_31.png)
...
![Review - resumo completo da configuração do controle antes de criar](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_32.png)
...
![Página de Controls com notificação de controle criado com sucesso e cards de resumo atualizados](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_33 copy.png)
...
![Menu hambúrguer com opção Build selecionada para acessar o agente](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_34.png)

Escolha o agente que teve o controle aplicado

![Lista de agentes no Build - seleção do agente com o controle aplicado](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_35.png)


Envie uma pergunta extremamente ofensiva e de baixo calão para ver o guardrail recém-criado operando no agente.

![Preview do agente - guardrail de Content Guardrails bloqueando mensagem ofensiva](../../Assets_for_BuildBooks/monitoring_labs/lab06/lab06_monitoring_36.png)
